...
<html lang="en">
<head>
<title>El Perro de Pavlov | Iniciar Sesión</title>
<meta charset="utf-8">
      ...
      <div class="menu_block">
        <nav>
          <ul class="sf-menu">
            ...
            <li class="with_ul"><a href="Quienes-Somos.html">Quiénes Somos</a></li>
            <li><a href="Servicios.html">Servicios</a></li>
            <li><a href="Contactanos.html">Contactanos</a></li>
            <li><a href="Iniciar-Sesion.jsp">Iniciar Sesion</a></li>
          </ul>
        </nav>
        <div class="clear"></div>
      </div>
...
<div class="content pt1">
  <div class="container_12">
    ...
    <div class="grid_5 prefix_1">
      ...
      <form id="form" name="form" action="menu admi.html">
        ...
        <fieldset>
          ...
          <div class="clear"></div>
          <div class="btns"><a data-type="reset" class="btn">Entrar</a>
            <div class="clear"></div>
          </div>
        </fieldset>
      </form>
