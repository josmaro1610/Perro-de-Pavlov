...
<html lang="en">
<head>
<title>El Perro de Pavlov | Vacuna</title>
<meta charset="utf-8">
...
<div class="content pt1">
  <div class="container_12">
    <div class="grid_6">
      ...
      <h2 class="ic1">Registrar Vacuna</h2>
      <form id="form" action="#">
        ...
        <fieldset>
          ...
          <label class="datetime">
            <input type="text" value="Fecha Nacimiento:">
            <br class="clear">
            <span class="error error-empty">*This is not a valid date.</span><span class="empty error-empty">*This field is required.</span> 
          </label>
            
            <select name="Tipo Vacuna" class="label">
                <option>Rabia</option>
                <option>Distemper</option>
                <option>3-1</option>
                
            </select>
            <span class="error error-empty">*This is not a valid weight.</span><span class="empty error-empty">*This field is required.</span> 
