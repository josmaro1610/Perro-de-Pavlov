...
<html lang="en">
<head>
<title>El Perro de Pavlov | PublicaciÃ³n</title>
<meta charset="utf-8">
...
jQuery(document).ready(function () {
 ...
 /* Abrimos etiqueta de código */
    ...
    if (document.form.titulo.value.length==0){
...
<div class="content pt1">
  <div class="container_12">
    <div class="grid_6">
      ...
      <h2 class="ic1">Registrar Publicación</h2>
      <form id="form" name ="form" action="#">
        ...
        <fieldset>
          ...
          <label class="name">
            <input type="text" placeholder="Creador Por:" name="dueno">
            <br class="clear">
          </label>
          <label class="email">
